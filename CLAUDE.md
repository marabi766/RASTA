...
> **پیش از شروع هر کار غیرپیش‌پاافتاده، ابتدا
> [`PROJECT_MEMORY.md`](PROJECT_MEMORY.md) را بخوان.** آن فایل، حافظه مهندسی
> زنده پروژه است: چه چیزی واقعاً پیاده و تست و Live-Verify شده، چه چیزی فقط
> Scaffold است، چه Known Issue هایی باز مانده و گام بعدی واقعی کدام است —
> جداگانه از این سند که فقط راهنمای دستورها و قواعد است.
...
| منبع                        | مسیر                             |
| --------------------------- | -------------------------------- |
| **وضعیت واقعی/حافظه پروژه** | **`PROJECT_MEMORY.md`**          |
...
| **شاخه‌ها و کار موازی**     | **`docs/26-branch-registry.md`** |
