...
وضعیت `Proposed` دارد و **هیچ کدی پیاده نشده**. آنچه در ۲۰۲۶-۰۹-۰۴ عوض شد،
دقت توصیف مسئله است، نه وضعیت حل آن.
...
**آنچه هنوز نرسیده.** **D-027 باز می‌ماند** و ADR-051 همچنان `Proposed` است.
Q-36 دیگر دروازهٔ Phase B نیست؛ تنها دروازهٔ باقی‌مانده پذیرش خود ADR-051 است.
هیچ کدی پیاده نشده و Phase B شروع نشده.
