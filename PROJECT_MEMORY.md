...
> | **CI**        | ✅ Run `33251526142`، Commit `a6fc4f2`، هر ۴ Job سبز (PR #4)             |
>
> ---
>
...
> بسته است و CI روی PR #4 سبز است (Run `33251526142`). عنوان تا **تأیید صاحب
> محصول** عمداً `READY_FOR_NEXT_PHASE` نیست — PR هنوز Merge نشده، و سه یافته
> باز (Q-26 تا Q-28) تصمیم انسانی می‌خواهند.
...
| CI VERIFIED   | ✅ Run `33251526142`، Commit `a6fc4f2` — Quality، Security، Integration و **E2E** سبز       |
