...
- Frontend — **بقیهٔ صفحه‌های دامنه‌ای**: از `EXP-002` ورود، داشبورد، دو
  صفحهٔ دارایی، ثبت کارکرد، دو صفحهٔ نگهداری و دو صفحهٔ راننده ساخته شده؛
  فقط سازمان و اعضا مانده. `EXP-003` تا `EXP-005` شروع نشده‌اند. `apps/admin`
