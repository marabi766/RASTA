...
>
> **آنچه هنوز نیست:** این ردهای تازه جزء ده محل رد اللگوی AUD-004
...
**گام اجرایی بعدی:** بقیهٔ `EXP-002` — راننده و تخصیص، ثبت کارکرد، نگهداری، و
سازمان و اعضا. نخستین صفحه‌هایی که **می‌نویسند**، پس نخستین جایی که توکن CSRF،
کلید یکتایی درخواست و بازگرداندن خطای اعتبارسنجی سرویس به فرم وارد کار می‌شوند.
ترتیب همچنان از `planning/backlog.json` خوانده می‌شود.
...
- Frontend — **بقیهٔ صفحه‌های دامنه‌ای**: از `EXP-002` ورود، داشبورد، دو
  صفحهٔ دارایی و دو صفحهٔ نگهداری ساخته شده؛ راننده و تخصیص، ثبت کارکرد، و
  سازمان و اعضا مانده‌اند. `EXP-003` تا `EXP-005` شروع نشده‌اند. `apps/admin`
