...
**تصمیم محصول باقی‌مانده:** **Q-36** — کلاس جریان‌های `fleet` و `maintenance`
(ترتیب اکید یا فقط تشخیص شکاف). با فرض پر نشد و Phase B تا پاسخش شروع نمی‌شود.
