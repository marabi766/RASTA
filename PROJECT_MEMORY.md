...
| D-026 | ادعای رزرو `FOR UPDATE SKIP LOCKED` در Outbox دوام ندارد                         | **بالا**                        | دو نمونه رله می‌توانند یک ردیف را هم‌زمان Claim و در Kafka منتشر کنند (Overlap اندازه‌گیری‌شده: ۱۰ از ۱۰) | نیازمند ADR؛ در PR #21 فقط ثبت شد و کد اجرایی دست نخورد — پایین‌تر                                          |
