...
| `notification-service` | IMPLEMENTED · TESTED · **CI VERIFIED** — ۱۸۰ واحد + ۷۰ یکپارچگی؛ `NTF-001` و `NTF-002` روی `main` (`ADR-054`)        |
...
_آخرین Audit کامل: 2026-08-27. آخرین به‌روزرسانی: **2026-09-18** — شش Merge،
`main` روی `f7252d3`، اجرای سبز `35364991343`. پیش‌تر: 2026-08-30 (Baseline سنجش پیشرفت).
