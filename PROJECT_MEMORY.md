...
| **supplier-service — فاز ۱: پروفایل/صلاحیت/تعلیق/فهرست**         |                          ✅                           | ✅ ۴۱۷ واحد + ۱۲۶ یکپارچگی | ✅ زنده روی PostgreSQL و Kafka واقعی؛ Coverage ۹۲٫۰۸٪ Statement / ۸۴٫۲۵٪ Branch با دروازهٔ ۷۵٪ در CI. امتیاز عملکرد پیاده **نشد** (Q-12 باز). PR باز، پذیرش نشده. |
