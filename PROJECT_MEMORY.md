...
| **پورتال کاربر (`apps/web`) — ورود، داشبورد و صفحه‌های دارایی**  |                          ✅                           | ✅ (۳۷۸ واحد + ۳ مرورگری)  | ⚠️ **CI VERIFIED**، نه زنده: Job ‏`Portal in a browser` در برابر Build تولیدی سبز است؛ ورود و صفحه‌های دارایی هرگز در برابر Keycloak و Gateway زنده اجرا نشده‌اند (`ADR-059`)                                                                                              |
