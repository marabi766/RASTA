...
### به‌روزرسانی 2026-09-18 — ۵۶ ADR روی `main` (`ADR-001` تا `ADR-056`)
...
- **`ADR-057` رزرو است** برای شاخهٔ `docs/audit-immutable-archive`، که امروز
  هنوز به‌غلط شمارهٔ `055` را دارد و باید بازشماری کند. ثبت در
  `docs/26-branch-registry.md § ۲۶٫۵`.
