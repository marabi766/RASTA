...
| **پورتال کاربر (`apps/web`) — ورود، داشبورد، صفحه‌های دارایی و نگهداری** |                          ✅                           | ✅ (۴۰۳ واحد + ۳ مرورگری)  | ⚠️ **CI VERIFIED**، نه زنده: Job ‏`Portal in a browser` در برابر Build تولیدی سبز است؛ ورود، صفحه‌های دارایی و صفحه‌های نگهداری هرگز در برابر Keycloak و Gateway زنده اجرا نشده‌اند (`ADR-059`)                                                                            |
