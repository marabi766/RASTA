...
| D-026 | ادعای رزرو `FOR UPDATE SKIP LOCKED` در Outbox دوام ندارد                         | **بالا**                        | دو نمونه رله می‌توانند یک ردیف را هم‌زمان Claim و در Kafka منتشر کنند (Overlap اندازه‌گیری‌شده: ۱۰ از ۱۰)                      | **ADR-050 (Proposed)** طراحی را دارد؛ هنوز پیاده نشده. Phase A فقط طراحی و شواهد بود                        |
...
**۶۰ ثانیه** پس از این تحلیل انتخاب شد، با Heartbeat هر Lease/۳.
