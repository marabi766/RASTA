...
export const WALKTHROUGH: readonly WalkthroughStep[] = [
  ...
  {
    id: 'audit',
    title: 'سوابق حسابرسی — شواهد فقط‌الحاقی',
    action: 'فهرست رویدادهای حسابرسی را باز کنید، یک رکورد را ببینید و زنجیرهٔ Hash را بررسی کنید.',
    point:
      'هر تغییر وضعیتی که پلتفرم ثبت می‌کند، یک سند فقط‌الحاقی می‌شود. بررسی زنجیره، دست‌کاری را مشهود می‌کند — نه امضای رمزنگاری‌شده، نه لنگر خارجی. AUD-001 تا AUD-003 روی main مرج شده‌اند؛ اصلاح رکورد (AUD-004) هنوز ساخته نشده است.',
    minutes: 2,
    capabilityKey: 'audit',
  },
  {
