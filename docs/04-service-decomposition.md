...
| **مالکیت داده**  | `catalog` · `product` · `offer` · `price_history` · `cart` · `order` · `order_line` · `fulfillment` · `delivery` · `review` · `order_dispute`                                                                                                                                           |
...
| **Dependencies** | PostgreSQL · Kafka · Redis (سبد) · OpenSearch (جست‌وجو) · Temporal (Saga سفارش) · `economic-service`                                                                                                                                                                                    |
