...
> آزمون** با دو Relay روی یک Partition. جزئیات و طرح پیشنهادی در
> [ADR-051](adr/ADR-051-outbox-semantic-ordering.md) (`Proposed`)؛ مسئله به‌عنوان
> **D-027** باز است.
...
> بازپخش دستی DLQ می‌توانند رویداد بعدی را جلو بیندازند. تا پذیرش و اجرای
> [ADR-051](adr/ADR-051-outbox-semantic-ordering.md)، این ردیف‌ها را «هم‌Partition
> بودن» بخوانید، نه «مرتب بودن». مسئله **D-027** است و باز می‌ماند.
