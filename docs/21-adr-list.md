...
| [051](adr/ADR-051-outbox-semantic-ordering.md)         | ترتیب معنایی هر جریان در Outbox                | Proposed | **D-027 (باز)**، بستن Q-36           |
...
**آنچه هنوز نرسیده.** **D-027 باز می‌ماند و این ADR `Proposed` است**؛ هیچ کدی پیاده
نشده. تنها دروازهٔ باقی‌مانده برای Phase B، پذیرش صریح خود ADR-051 است.
