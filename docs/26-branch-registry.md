...
**آخرین به‌روزرسانی:** ۱۴۰۵/۰۶/۲۸ (2026-09-19) · **`main` در آن لحظه:** `4b15725`
...
| ---------------------------- | ------------------------------------------ | ---- | --- | -------------- | ---------------------------------------------------------------------------- |
| `feat/web-component-library` | `F:\Rasta-Parallel\exp-001-web-foundation` | C0   | —   | ۱ / ۰          | `EXP-001` PR پ — Radix، چیدمان، فرم، و سه حالت اجباری § ۱۶٫۴                 |
