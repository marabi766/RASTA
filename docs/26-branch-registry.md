...
**آخرین به‌روزرسانی:** ۱۴۰۵/۰۶/۲۷ (2026-09-18) · **`main` در آن لحظه:** `f7252d3` — هیچ PR بازی نیست
...
| -------------------------------- | ------------------------------------------------ | ---- | --- | -------------- | ------------------------------------------------------------------------------------ |
| `docs/project-memory-2026-09-18` | `F:\Rasta-Parallel\docs-branch-registry`         | C0   | —   | ۰ / ۰          | به‌روزرسانی `PROJECT_MEMORY.md` پس از شش ادغام امروز؛ فقط مستندات                    |
| `docs/audit-immutable-archive`   | `F:\Rasta-Parallel\audit-immutable-archive-docs` | —    | —   | ۱ / ۱۶۶        | **متوقف، نیازمند اقدام:** `ADR-055` تکراری دارد (باید `ADR-057` شود) و یک `Q-44` سوم |
| `demo/investor-preview`          | `F:\Rasta-Parallel\investor-demo`                | —    | —   | ۳۴ / ۱۶۶       | شاخهٔ نمایشی بلندمدت؛ هرگز در `main` ادغام نمی‌شود                                   |
