...
| ----------------------------------- | --------------------------------- | ----- | ---- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `claude/adoring-cerf-nhq97e`        | نشست ابری (Cloud)                 | Cloud | —    | ۰ / ۰          | تازه ساخته شد از `origin/main` @ `b89e192` — `organization-service`: سخت‌سازی سلسله‌مراتب و یکپارچگی (دید `nearby`، عمق و چرخهٔ `move`، وضعیت نیا، CAS وضعیت، Audit تماس، مرجع تنظیم سیاست حکمرانی)؛ رزرو `Q-64` |
