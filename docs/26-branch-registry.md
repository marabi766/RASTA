...
| `fix/document-upload-immutability` | `F:\Rasta-Parallel\document-upload-immutability` | —    | #91 | ۲ / ۱۰         | **P0 امنیتی، تأییدشدهٔ PM** — همگام با `origin/main` پس از #83 و #88؛ کد و تست‌ها پیشتر Verify شده بودند (۲۸۳ Unit، ۱۸۵ Integration روی زیرساخت واقعی)؛ PR باز، منتظر ادغام — طبق قاعدهٔ ۶، ادغام کار PM/کاربر است                                                                                               |
