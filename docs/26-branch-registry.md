...
**آخرین به‌روزرسانی:** ۱۴۰۵/۰۶/۲۹ (2026-09-20) · **`main` در آن لحظه:** `8a80ce5`
...
| ------------------------------- | ------------------------------------------ | ---- | ------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------------------ |
| `feat/notification-preferences` | `F:\Rasta-Parallel\exp-001-web-foundation` | C0   | [#60](https://github.com/marabi766/RASTA/pull/60) | ۳ / ۰          | `NTF-003` — ترجیحات اعلان، نردبان تقدم و بستن `Q-38`؛ به‌علاوهٔ رفع نشت Producer کافکا در خاموشی |
...
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------- |
| `docs/24-open-questions.md`                                 | هر شاخه پرسش تازه‌اش را ته همین فایل می‌افزاید و جدول § ۲۴٫۱۰ را بازمی‌شمارد. **منبع هر سه حادثهٔ § ۲۶٫۱.** | `feat/notification-preferences` |
...
| `PROJECT_MEMORY.md`                                         | همه بعد از ادغام می‌خواهند به‌روزش کنند                                                                     | `feat/notification-preferences` |
