...
| `feat/web-wallet-marketplace-surfaces` | `F:\Rasta-Parallel\web-wallet-marketplace`    | —    | #85 | ۴ / ۰          | `EXP-003`: `/wallet`، `/marketplace`، `/marketplace/[productId]` (بخش فقط‌خواندنی این Epic)؛ همگام با `origin/main` پس از #83، #86 و #88. PR باز، منتظر ادغام — طبق قاعدهٔ ۶، ادغام کار PM/کاربر است                                                                                                                                                                                                                    |
