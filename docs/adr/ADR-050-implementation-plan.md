...
>
> **این سند اجرا شده است.** Phase B روی هر هشت سرویس پیاده و با CI روی PR باز
> #23 تأیید شده؛ شواهد اندازه‌گیری‌شده در بخش «شواهد اجرا» پایین همین سند است.
> آنچه هنوز **انجام نشده** پذیرش است، نه کار: ADR-050 همچنان `Proposed` و
> D-026 همچنان باز است تا صاحب محصول تأیید کند و اجرای پس از Merge روی `main`
> سبز شود. بخش‌های «توالی Commit» و «آزمون‌های الزامی» پایین، طرح اولیه‌اند و
> به‌عنوان طرح خوانده می‌شوند، نه به‌عنوان کار باقی‌مانده.
