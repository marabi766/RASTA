...
`COM-006` نیازمند شواهد واقعی § ۳ (همروندی رزرو) و § ۵/§ ۶ (رهگیری واقعی و
قابل‌مشاهده برای کاربر مجاز) است — دقیقاً همان چیزی که برنامهٔ اجرا در § ۱۲
مشخص می‌کند، نه صرفاً تعریف Interface این پورت‌ها.
