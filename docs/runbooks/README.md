...
| [security-event-outbox](security-event-outbox.md) | `rasta_security_event_outbox_pending_age_seconds > 60` (پیشنهادی؛ قاعده هنوز نیست)            | 🟠 هشدار   | ✅ آماده  |
| [audit-gap-detected](audit-gap-detected.md)       | ندارد — قاعدهٔ هشدار هنوز نیست؛ رکورد حسابرسی مورد انتظار غایب · پیام در `rasta.audit.v1.dlq` | 🔴 بحرانی  | ✅ آماده  |
