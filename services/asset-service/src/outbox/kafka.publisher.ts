 ...
 *
 * Producer settings are chosen for correctness over throughput, because the
 * events this carries decide whether a commission is charged:
 *
 ...
 *                          is what makes "hold then release" arrive in order
 */
@Injectable()
