 ...
 *
 * Nearly everything here is scoped, because nearly everything here belongs to
 * exactly one organization at a time. `OrganizationRef` is the exception: it
 * is platform-wide reference data replicated from events, and it is never
