...
--
-- Drops both tables (the evaluations and the cutover), and with them the
-- guarantee, not any money: rewards and journals are untouched. The consumer then has only processed_event and
