 ...
 *                          is what keeps MAINTENANCE_STARTED and
 *                          MAINTENANCE_COMPLETED for the same machine in the
 *                          order they happened — reversed, they would leave the
 *                          asset stuck in IN_MAINTENANCE
 */
@Injectable()
